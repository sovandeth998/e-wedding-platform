...
import { Crown, Clock, MapPin, Volume2, VolumeX, Send, CheckCircle2, MailOpen, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#140406] text-stone-100 font-sans selection:bg-amber-500 selection:text-black flex justify-center">
      ...
      {!isOpen && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-md flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-gradient-to-b from-[#2A080C] to-[#1A0407] border-2 border-[#DFBA73]/60 rounded-[36px] p-8 text-center shadow-[0_0_60px_rgba(223,186,115,0.3)] space-y-6 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#DFBA73_1px,transparent_1px)] [background-size:16px_16px]"></div>
            
            <div className="w-20 h-20 mx-auto rounded-full bg-amber-500/10 border-2 border-[#DFBA73]/40 flex items-center justify-center text-[#DFBA73] shadow-inner">
              <Crown className="w-10 h-10 animate-pulse" />
            </div>

            <div className="space-y-2">
              <p className="text-[11px] text-[#DFBA73] font-bold tracking-[0.3em] uppercase">The Royal Wedding</p>
              <h2 className="text-xl font-['Moul'] text-amber-100" style={{ lineHeight: '2.0' }}>សិរីសួស្តី អាពាហ៍ពិពាហ៍</h2>
            </div>

            {/* រូបតំណាងគូស្វាមីភរិយាលើ Cover */}
            <div className="relative w-28 h-28 mx-auto rounded-full overflow-hidden border-2 border-[#DFBA73] shadow-xl">
            ...
            <button onClick={handleOpenInvitation} className="w-full bg-gradient-to-r from-amber-300 via-amber-500 to-amber-600 text-stone-950 py-4 rounded-2xl text-sm font-bold shadow-xl flex items-center justify-center gap-2 hover:brightness-110 active:scale-95 transition tracking-wide">
      ...
      {isOpen && (
        <div className="w-full max-w-md bg-[#1C0507] min-h-screen border-x border-amber-900/40 shadow-2xl relative pb-24 overflow-hidden">
          
          {/* Header & Main Couple Image */}
          <div className="pt-12 pb-8 text-center px-6 space-y-6 relative">
            ...
            <div className="relative w-full h-72 rounded-3xl overflow-hidden border-2 border-amber-500/40 shadow-2xl group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#1C0507] via-transparent to-transparent opacity-80"></div>
            ...
            <div className="bg-[#2A080C] p-4 rounded-2xl border border-amber-500/30 shadow-lg space-y-1">
          ...
          {/* កំរងរូបភាពបន្ថែម (Gallery Photos) */}
          <div className="px-6 py-4 space-y-3 border-t border-amber-900/30">
          ...
          <div className="px-6 py-6 space-y-4 border-t border-amber-900/30">
            ...
            <div className="space-y-3">
              <div className="bg-[#2A080C] p-4 rounded-2xl border border-amber-900/60 flex items-center gap-4 shadow-md">
          ...
          <div className="px-6 py-6 space-y-4 border-t border-amber-900/30">
            ...
            <a href={WEDDING_CONFIG.googleMapsUrl} target="_blank" rel="noreferrer" className="w-full bg-[#DFBA73] text-stone-950 py-3 rounded-xl text-xs font-bold flex items-center justify-center gap-2 shadow-lg hover:bg-amber-300 transition">
          ...
          <div className="px-6 py-6 space-y-4 border-t border-amber-900/30">
            ...
            {rsvpSent ? (
              ...
              <form onSubmit={handleRsvpSubmit} className="space-y-3">
                ...
                <button type="submit" className="w-full bg-gradient-to-r from-amber-300 via-amber-500 to-amber-600 text-stone-950 py-3 rounded-xl text-xs font-bold shadow-lg hover:brightness-110 transition">បញ្ជាក់ការចូលរួម</button>
              </form>
            )}
          </div>
